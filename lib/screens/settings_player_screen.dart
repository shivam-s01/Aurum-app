...
class _SettingsPlayerScreenState extends State<SettingsPlayerScreen> {
  ...
  // Notify audio handler to reload settings immediately (no restart needed)
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: AurumTheme.dividerOf(context), width: 0.5),
            ),
            child: Padding(
                  ...
                  Row(
                    ...
                    children: const [
                      ...
                      '1.25×', '1.5×', '1.75×', '2×'
                        ...
                        .map((l) => Text(l,
                            style: TextStyle(
                                color: AurumTheme.gold, fontSize: 9)))
                        .toList(),
                  ),
                ],
              ),
      ...
      appBar: _appBar(context, 'Equalizer', actions: [
        TextButton(
          ...
          child: const Text('Reset',
              style: TextStyle(color: AurumTheme.gold, fontSize: 14)),
        ),
      ]),
      body: ListView(
        padding: const EdgeInsets.fromLTRB(16, 8, 16, 100),
...
Widget _switchTile(BuildContext context,
    ...
    Container(
      ...
      child: ListTile(
        ...
        trailing:
            Switch(value: value, onChanged: onChanged, activeColor: AurumTheme.gold),
      ),
    );
