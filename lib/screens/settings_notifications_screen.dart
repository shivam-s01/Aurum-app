      ...
      body: ListView(
        ...
        children: [
          ...
          _switchTile(context,
            ...
            onChanged: (v) { setState(() => _showMediaNotif = v); _save('show_media_notif', v); AudioPrefs.showMediaNotif = v; _notifyHandler(); },
          ),
          _switchTile(context,
            ...
            onChanged: (v) { setState(() => _showArtworkInNotif = v); _save('show_artwork_notif', v); AudioPrefs.showArtworkNotif = v; _notifyHandler(); },
          ),
          _switchTile(context,
